...
<!-- Bootstrap datatables Core JavaScript -->
<script
...
<!-- jQuery UI -->
<script
	src="${pageContext.request.contextPath}/resources/js/jqueryui/jquery-ui.min.js"></script>
...
<script
	src="${pageContext.request.contextPath}/resources/js/perso/sb-admin-2.js"></script>

<script
	src="${pageContext.request.contextPath}/resources/js/perso/datatablesInitJS.js"></script>
